...
isPrimeIter i x e = if i == e 
                    then True 
                    else 
                        if mod x i == 0 
                        then False 
                        else isPrimeIter (i+1) x e 
...
triangleKind a b c = if a + b < c || a + c < b || b + c < a 
                     then -1 
                     else getTriangleKind ((a^2 + b^2 - c^2)/(2*a*b))  ((a^2 + c^2 - b^2)/(2*a*c))  ((b^2 + c^2 - a^2)/(2*c*b))

getTriangleKind a b c = if a == 0 || b == 0 || c == 0 
                        then 2 
                        else 
                              if a < 0 || b < 0 || c < 0 
                              then 0 
